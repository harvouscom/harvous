...
Discover the powerful features that make Harvous the perfect companion for your Bible study journey.
...
- **Search functionality**: Find any note or thread quickly

## 📱 Responsive Design

### Works Everywhere
- **Desktop**: Full-featured experience with all tools
- **Tablet**: Touch-friendly interface for note-taking
...
- **Search across all notes**: Find any insight instantly
- **Filter by space or thread**: Narrow down results
- **Date-based browsing**: See what you studied when
- **Tag-like organization**: Use spaces and threads as flexible tags
