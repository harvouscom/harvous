...
import churchJoin from './routes/church-join';
import churchReview from './routes/church-review';
import churchMinistries from './routes/church-ministries';
import churchContent from './routes/church-content';
import studyPlanLeaderKit from './routes/study-plan-leader-kit';
...
import churchStudyPlanCopy from './routes/church-study-plan-copy';
...
app.route('/', churchJoin);
app.route('/', churchReview);
app.route('/', churchMinistries);
app.route('/', churchContent);
app.route('/', studyPlanLeaderKit);
app.route('/', churchSpacePlan);
app.route('/', churchEngagement);
app.route('/', churchSpaceLeaders);
app.route('/', churchPublishedMaterial);
app.route('/', churchStudyPlanCopy);
app.route('/', featured);
app.route('/', votd);
app.route('/', test);
