/**
 * Session tracker utilities — Drizzle port of src/utils/session-tracker.ts
 *
 * Only getTodaySessionCount uses the database; all other functions are pure
 * in-memory helpers re-exported as-is.
 */

import { db, UserXP, eq, and, gte } from '../db';
