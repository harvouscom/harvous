...
@class NSCoder;
/// NSLayoutManager subclass that draws study highlight underlines 2pt further from the text baseline,
/// giving a small visual gap between the text and the colored thick underline.
SWIFT_CLASS("_TtC7Harvous20HarvousLayoutManager")
@interface HarvousLayoutManager : NSLayoutManager
