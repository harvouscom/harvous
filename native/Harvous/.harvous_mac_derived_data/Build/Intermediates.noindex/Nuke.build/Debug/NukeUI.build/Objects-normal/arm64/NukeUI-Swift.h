...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NukeUI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// <code>LazyImageView</code> is a <code>LazyImage</code> counterpart for UIKit and AppKit with the equivalent set of APIs.
/// \code
...
///
/// \endcode
SWIFT_CLASS("_TtC6NukeUI13LazyImageView")
@interface LazyImageView : NSView
