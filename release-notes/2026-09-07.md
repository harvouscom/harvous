...
### A shared thread stops importing itself twice

**What changed:**
- Tapping "Add to Harvous" on a shared thread link a second time — a repeat tap, or reopening an old link — used to build a whole second copy of the thread and every note inside it, and told you it had worked both times.
- It now recognizes a thread you already added and takes you back to that copy instead of making another one.

**How it helps you:**
- Reopening a shared link you have already imported is safe. It will not leave you cleaning up duplicates.
