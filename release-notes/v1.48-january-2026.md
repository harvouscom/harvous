...
**What changed:**
- Endpoint to list all user threads for debugging
- Debug endpoint for thread count investigation
- Cleanup endpoint and unique constraint for NoteThreads to prevent duplicate entries
