...
<!-- Nothing user-facing in v3.5.6. The one fix in it is internal to Discover,
     which is not launched: its tables are empty and the marketing pages are
     behind DRAFT_PAGE_SLUGS. Drop this note when writing the real release —
     Discover gets its own announcement on the day it goes live. -->
