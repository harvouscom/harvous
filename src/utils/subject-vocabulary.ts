...
export const SUBJECT_VOCABULARY: Subject[] = [
  ...
  { name: 'Passover', category: 'narrative', synonyms: ['passover lamb', 'feast of passover', 'pascha', 'blood of the lamb', 'lamb of god', 'our passover lamb'] },
  { name: 'The Exodus', category: 'narrative', synonyms: ['exodus from egypt', 'leaving egypt', 'the red sea', 'deliverance from egypt', 'out of egypt', 'passover', 'the passover'] },
  { name: 'Biblical Feasts', category: 'narrative', synonyms: ['feasts of the lord', 'feast of unleavened bread', 'feast of weeks', 'feast of trumpets', 'day of atonement', 'feast of tabernacles'] },
  ...
  { name: 'The Last Supper', category: 'narrative', synonyms: ['upper room', 'the lord supper instituted', 'breaking bread together', "lord's supper", 'lords supper', 'communion', 'eucharist', 'breaking bread'] },
