 ...
 *
 * This endpoint finds and removes duplicate entries from NoteThreads table
 * keeping only the oldest entry for each (noteId, threadId) pair
 */
...
export const GET: APIRoute = async ({ request }) => {
  try {
    ...
    // Group by (noteId, threadId) combination
