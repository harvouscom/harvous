...
export default function ToastProvider() {
  ...
  return (
    <Toaster
      ...
      className="[&>[data-sonner-toaster]]:top-4 [&>[data-sonner-toaster]]:left-4 [&>[data-sonner-toaster]]:right-4 [&>[data-sonner-toaster]]:transform-none [&>[data-sonner-toaster]]:z-[9999]
