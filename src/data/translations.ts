...
export const TRANSLATIONS: Record<string, TranslationInfo> = {
  ...
  NKJV: {
    ...
    copyright:
      'Scripture quotations are from the New King James Version®. Copyright © 1982 by Thomas Nelson. All rights reserved.',
  ...
  NIV: {
    ...
    copyright:
      'Scripture quotations are from The Holy Bible, New International Version® NIV®. Copyright © 1973, 1978, 1984, 2011 by Biblica, Inc.™ All rights reserved worldwide.',
  ...
  NLT: {
    ...
    copyright:
      'Scripture quotations are from the Holy Bible, New Living Translation. Copyright © 1996, 2004, 2015 by Tyndale House Foundation and Tyndale House Publishers, Carol Stream, Illinois 60188. All rights reserved.',
  ...
  NASB: {
    ...
    copyright:
      'Scripture quotations taken from the New American Standard Bible® (NASB 1995), Copyright © 1960, 1971, 1977, 1995 by The Lockman Foundation. All rights reserved.',
  ...
  CSB: {
    ...
    copyright:
      'Christian Standard Bible®, CSB® Copyright © 2017 by Holman Bible Publishers. All rights reserved.',
  ...
  AMP: {
    ...
    publisher: 'The Lockman Foundation',
    copyright:
      'Scripture quotations marked AMP are taken from the Amplified® Bible, Copyright © 2015 by The Lockman Foundation. All rights reserved.',
    website: 'https://www.lockman.org',
    isPublicDomain: false,
    sortOrder: 9,
  },
  MSG: {
    ...
    publisher: 'NavPress',
    copyright:
      'Scripture quotations marked MSG are taken from THE MESSAGE, copyright © 1993, 2002, 2018 by Eugene H. Peterson.',
