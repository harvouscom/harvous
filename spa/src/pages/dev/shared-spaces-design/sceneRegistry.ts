...
export const SHARED_SPACES_DESIGN_SCENES: SharedSpacesDesignScene[] = [
  ...
  },
  {
    ...
    phase: 'Shell',
    editFiles: ['spa/src/pages/prototype/PrototypeSpaceHub.tsx'],
  ...
  },
  {
    ...
    phase: 'Collaboration',
    editFiles: ['spa/src/pages/prototype/SharedSpaceNoteAuthorChip.tsx', 'spa/src/pages/prototype/PrototypeSpaceHub.tsx'],
