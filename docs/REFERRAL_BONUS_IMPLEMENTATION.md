...
Everyone gets **500 free notes** to start. When someone you refer signs up, **you** (the referrer) get **100 more notes** added to your limit—the new person still gets 500 free notes like everyone else. This uses **Option A: raise the limit**—the referrer's effective cap is `500 + (100 × successful referrals)`. Referral links use a short, **autogenerated code** (e.g. `JOHN-X7K2`) instead of your account ID. This fits Harvous's "generosity payback" positioning.
