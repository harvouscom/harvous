...
- **Unorganized threads** and **note counts** (including **note-type counts** in navigation data) are handled more accurately—less confusion when things sit outside a tidy folder.  
