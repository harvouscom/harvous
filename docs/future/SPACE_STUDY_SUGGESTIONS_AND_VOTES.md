...
**Status: designed, not built (Sep 2026).** Decisions below were taken with Derek; the
reasoning is recorded because the code can be read later and the reasoning cannot.
