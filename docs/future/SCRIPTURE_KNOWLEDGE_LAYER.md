...
- **Phase 3 — Remember surfaces (done).** Extend `prototype-home-trends.ts` to resurface by shared
  theme / passage / cross-reference on prototype Home: shared-theme card (`deriveSubjectConnections` +
