...
4. **[Open in current/active space](./04-open-in-current-space.md)** – Notes what was tried for “open in current space” (nav/layout/dashboard) and what still needs to be fixed; not yet resolved.
